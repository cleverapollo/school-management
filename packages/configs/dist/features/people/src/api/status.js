...
var statusQuery = function (studentId) { return ({
    queryKey: studentKeys.details(studentId),
    queryFn: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, gqlClient.request(statusByStudentid, {
...
export function useStudentStatus(studentId) {
    return useQuery(__assign(__assign({}, statusQuery(studentId)), { select: function (_a) {
            var composite_studentStatus = _a.composite_studentStatus;
            return composite_studentStatus;
        } }));
}
