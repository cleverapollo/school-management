...
var LIGHT_MODE = palette.light.slate[500];
var DARK_MODE = '#000000';
...
var createCustomShadow = function (color) {
    ...
    return {
        ...
        //
        primary: "0 8px 16px 0 ".concat(alpha(palette.light.primary.main, 0.24)),
        info: "0 8px 16px 0 ".concat(alpha(palette.light.info.main, 0.24)),
        secondary: "0 8px 16px 0 ".concat(alpha(palette.light.secondary.main, 0.24)),
        success: "0 8px 16px 0 ".concat(alpha(palette.light.success.main, 0.24)),
        warning: "0 8px 16px 0 ".concat(alpha(palette.light.warning.main, 0.24)),
        error: "0 8px 16px 0 ".concat(alpha(palette.light.error.main, 0.24)),
        //
