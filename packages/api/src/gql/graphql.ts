...
export type OptionsSetupQuery = { __typename?: 'Query', options_options: Array<{ __typename?: 'Option', id: number, name: string, yearGroupEnrolmentParty: { __typename?: 'YearGroupEnrollment', name: string }, students?: Array<{ __typename?: 'Person', partyId: number, firstName?: string | null, lastName?: string | null, avatarUrl?: string | null, type?: PartyPersonType | null }> | null, subjectSets: Array<{ __typename?: 'OptionSubjectSet', name: string, canChoose: number, poolIdx?: number | null, id: { __typename?: 'OptionsId', optionId: number, idx: number }, subjects: Array<{ __typename?: 'Subject', id: number, name: string, colour?: Colour | null }> }> }> };
