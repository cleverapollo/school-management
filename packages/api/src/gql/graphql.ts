...
export type CalendarDayInfoQuery = { __typename?: 'Query', calendar_dayInfo: Array<{ __typename?: 'CalendarDayInfo', date: string, dayType: DayType, startTime?: string | null, endTime?: string | null, periods: Array<{ __typename?: 'CalendarGridPeriodInfo', type: CalendarGridPeriodType, startTime: string, endTime: string }> }> };
