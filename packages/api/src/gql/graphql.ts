...
export type Attendance_ParentalAttendanceRequestsQuery = { __typename?: 'Query', attendance_parentalAttendanceRequests: Array<{ __typename?: 'ParentalAttendanceRequest', id: number, adminNote?: string | null, attendanceCodeId: number, contactPartyId: number, from: string, parentNote: string, requestType: ParentalAttendanceRequestType, status: ParentalAttendanceRequestStatus, studentPartyId: number, to: string, createdOn: string, classGroup?: { __typename?: 'GeneralGroup', name: string } | null, contact: { __typename?: 'Person', avatarUrl?: string | null, firstName?: string | null, lastName?: string | null }, student: { __typename?: 'Person', avatarUrl?: string | null, firstName?: string | null, lastName?: string | null } }> };
