...
export type LabelMutationMutation = { __typename?: 'Mutation', communications_label?: { __typename?: 'Label', id: number, name: string, personPartyId: number, colour?: string | null, custom?: boolean | null } | null };
