...
export type Swm_EventsForSubstitutionStaffByDay = {
  ...
  absence?: Maybe<Swm_StaffAbsence>;
  date?: Maybe<Scalars['Date']>;
...
export type Swm_SubstitutionsFilter = {
  byAbsenceDates?: InputMaybe<Array<Swm_UpsertStaffAbsenceDate>>;
