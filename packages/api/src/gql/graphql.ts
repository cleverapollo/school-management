...
export type Notes_BehaviourFilter = {
  ...
  partyIds?: InputMaybe<Array<Scalars['Long']>>;
...
export type Notes_StudentBehaviour = {
  ...
  noteId: Scalars['Long'];
  referencedParties: Array<Maybe<Party>>;
  referencedPartyIds?: Maybe<Array<Maybe<Scalars['Long']>>>;
