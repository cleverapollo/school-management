...
export type Calendar_UpsertBellTimeMutationVariables = Exact<{
  input?: InputMaybe<Calendar_CreateBellTimeInput>;
}>;


export type Calendar_UpsertBellTimeMutation = { __typename?: 'Mutation', calendar_upsertBellTime?: { __typename?: 'Success', success?: boolean | null } | null };
...
export const Calendar_UpsertBellTimeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"calendar_upsertBellTime"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Calendar_CreateBellTimeInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"calendar_upsertBellTime"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}}]}}]}}]} as unknown as DocumentNode<Calendar_UpsertBellTimeMutation, Calendar_UpsertBellTimeMutationVariables>;
